...
def add_to_collection():
    ...
    addform = FORM(DIV(
               ...
               DIV(INPUT(_name='value',_id='product_value',_placeholder = "Value of item...",requires=IS_NOT_EMPTY() and IS_INT_IN_RANGE(0,100001),_class="form-control")),
               BR(),
...
def edit_item():
    ...
    editform = FORM(DIV(
               ...
               BR(),
               DIV(LABEL('Value in £(British Pounds)*', _for='product_value')),
               DIV(INPUT(_name='value',_id='product_value',_value=record.price,_placeholder = "Value of item...",requires=IS_NOT_EMPTY() and IS_INT_IN_RANGE(0,100001),_class="form-control")),
               BR(),
               DIV(LABEL('Type*', _for='product_type')),
               DIV(SELECT('Advertising and Brand','Architectural','Art','Books,Magazines and Paper','Clothing,Fabric and Textiles','Coins,Currency,Stamps',
                          'Film and Television','Glass and Pottery','Household Items','Memorabilia','Music','Nature and Animals','Sports','Technology',
...
def advanced_search():
    searchform = FORM(DIV(
               ...
               INPUT(_name='price_range_max',_value = 100001,requires=IS_NOT_EMPTY() and IS_INT_IN_RANGE(0,10000),_class="form-control col-xs-8",_id='price_range_max'),_class='form-group col-xs-6'),
               BR(),
               BR(),
